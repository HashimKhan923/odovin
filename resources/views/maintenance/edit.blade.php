...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Update vehicle maintenance schedule</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="service_type" name="service_type" required
                           value="{{ old('service_type', $maintenance->service_type) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $maintenance->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="due_mileage" name="due_mileage"
                           value="{{ old('due_mileage', $maintenance->due_mileage) }}"
                ...
                <div>
                    ...
                    <input type="date" id="due_date" name="due_date"
                           value="{{ old('due_date', optional($maintenance->due_date)->format('Y-m-d')) }}"
                           class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <select id="priority" name="priority" required
                        ...
                        @foreach(['low','medium','high','critical'] as $level)
                            <option value="{{ $level }}"
                                {{ old('priority', $maintenance->priority) === $level ? 'selected' : '' }}>
                                {{ ucfirst($level) }}
                            </option>
                        @endforeach
                    </select>
